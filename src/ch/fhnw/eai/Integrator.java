...
public class Integrator {
    ...
    public void extrahiereKontokorrente() {
        ...
        while (iterator.hasNext()) {
            ...
            kunde.setLaendercode(laendercodeGenerieren(kunde.getAdresse()));
    ...
    //Ländercode generieren
    public String laendercodeGenerieren(String adresse) {
        
        String[] array = adresse.split("\\,");
        array[1] = array[1].replaceAll("[\\D]", "");
        if (array[1].length() < 5) {
            return "CH";
        } else if (array[1].length() == 5) {
            return "DE";
        }
        else {
            return "--";
